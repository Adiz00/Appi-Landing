    ...
    const features = [
      {
        ...
        description:
          "We ensure that our unique qualities make Appicoders stand out from the crowd. We put the needs of our clients ahead of us.",
        isCenter: false,
      },
      {
        icon: (
      ...
      },
      {
        ...
        description:
          "Appicoders provides services at affordable price and with our flexible payment terms, you pay as your project progresses.",
        isCenter: false,
      },
    ]
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <div
                key={index}
                className={`
                  ${feature.isCenter ? "bg-white shadow-2xl scale-105 md:scale-110 z-10" : "bg-transparent"}
                  rounded-full p-8 text-center transition-transform duration-300 hover:scale-105
                `}
              >
                {/* Icon */}
                <div
